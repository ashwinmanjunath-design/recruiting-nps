...
// ============================================
// MOCK DATA
// TODO: Replace local state with API calls to /api/actions
// ============================================
const INITIAL_ACTIONS: ActionItem[] = [
  // Candidate actions
  {
    id: 'action-1',
    title: 'Reduce interview wait times',
    description: 'Candidates report long waits between interview rounds. Target: reduce from 5 days to 2 days.',
    sourceInsight: 'NPS Trend',
  ...
  {
    id: 'action-2',
    title: 'Improve rejection feedback template',
    description: 'Create more personalized rejection emails with specific feedback points.',
    sourceInsight: 'Candidate Themes',
    owner: 'HR Team',
    dueDate: '2024-12-20',
    status: 'Open',
    createdAt: '2024-11-25T14:00:00Z',
    createdBy: 'Recruiting Team',
    audience: SurveyAudience.CANDIDATE,
  },
  {
    id: 'action-3',
    title: 'Clarify job requirements in postings',
    description: 'Review and update all active job postings to include clearer requirements and expectations.',
    sourceInsight: 'Geographic Insights',
  ...
  // Hiring Manager actions (using Q1-Q7 metric labels)
  {
    id: 'action-4',
    title: 'Reduce screening to onsite time',
    description: 'Hiring managers report long wait times (Q4: Process Speed). Target: reduce from 8 days to 5 days.',
    sourceInsight: 'Process Speed Satisfaction',  // Q4
    owner: 'TA Leadership',
    dueDate: '2024-12-18',
    status: 'In Progress',
  ...
  {
    id: 'action-5',
    title: 'Improve candidate pipeline quality',
    description: 'Senior roles have low quality scores (Q2: Candidate Quality). Implement better screening criteria.',
    sourceInsight: 'Candidate Quality Satisfaction',  // Q2
    owner: 'Sourcers',
    dueDate: '2024-12-22',
    status: 'Open',
    createdAt: '2024-12-02T11:00:00Z',
    createdBy: 'TA Manager',
    audience: SurveyAudience.HIRING_MANAGER,
    location: 'berlin',
  },
  {
    id: 'action-8',
    title: 'Improve recruiter communication frequency',
    description: 'HMs want more proactive updates (Q6: Communication & Partnership). Implement weekly status calls.',
    sourceInsight: 'Communication & Partnership',  // Q6
    owner: 'TA Partners',
    dueDate: '2024-12-20',
    status: 'Open',
  ...
  {
    id: 'action-6',
    title: 'Upgrade Berlin meeting rooms',
    description: 'Frequent complaints about meeting room availability and equipment.',
    sourceInsight: 'Workplace Survey',
  ...
  {
    id: 'action-7',
    title: 'Improve Day-1 laptop readiness',
    description: 'New hires report laptops not ready. Target: 95% ready on day 1.',
    sourceInsight: 'IT Support NPS',
    owner: 'IT Team',
    dueDate: '2024-12-25',
    status: 'In Progress',
...
const INITIAL_HISTORY: HistoryEntry[] = [
  {
    ...
    actionId: 'action-3',
    actionTitle: 'Clarify job requirements in postings',
    event: 'Status updated to Done',
    performedBy: 'Ashwin',
  },
  {
    id: 'hist-2',
    ...
    actionId: 'action-1',
    actionTitle: 'Reduce interview wait times',
    event: 'Status updated to In Progress',
    performedBy: 'Recruiting Team',
  },
  {
    id: 'hist-3',
